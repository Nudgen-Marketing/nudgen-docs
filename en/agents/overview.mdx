...
<CardGroup cols={3}>
  ...
  <Card title="API and MCP" icon="code" href="/en/agents/api">
    REST and MCP access with Personal Access Token auth for programmatic management.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Developer API" icon="code" href="/en/agents/api">
    REST endpoints and MCP tool mapping.
  </Card>
...
Next, explore the [Developer API](/en/agents/api).
