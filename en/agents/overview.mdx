...
**What the agent does:** Uses the REST API or MCP tools to create a contact and draft campaign copy. With MCP, you approve the exact send or schedule in your browser before the agent completes the launch.
...
- **MCP server**: Available through OAuth with workspace selection and browser approval for campaign launches.
