...
- A Nudgen account
- A CSV file with at least one email address (see [upload guide](/en/contacts/upload) for format)
...
When creating a campaign, you choose an audience: all contacts, or only those with certain tags. Tags make it easy to run different sequences for different segments. You can also [connect and sync a supported source](/en/integrations/connect-and-sync) to add contacts. Select its audience and complete the import before expecting those contacts in your campaign reach estimate.
...
- [Upload a CSV](/en/contacts/upload) to add contacts.
- [Create a campaign](/en/campaigns/create) and select your audience by tags or all contacts.
- Check [plan limits](/en/billing/overview) for max contacts per plan.
