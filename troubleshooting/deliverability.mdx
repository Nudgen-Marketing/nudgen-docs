...
- Check that you haven’t hit your **daily or monthly email limit**. The app blocks new sends when you’re over cap. See [Billing](/billing/overview) and [Troubleshooting: billing](/troubleshooting/billing).
...
- Upload or add at least one contact and ensure they’re **active** (not unsubscribed or suppressed). See [Contacts overview](/contacts/overview) and [Contact lifecycle](/contacts/lifecycle).
...
- Keep bounce rate low (e.g. under 2%) to protect sender reputation. Use the [Dashboard](/dashboard/overview) and [Campaign analytics](/campaigns/analytics) to monitor.
...
- Improve content: clear subject lines, relevant copy, obvious unsubscribe link. Don’t send to people who didn’t opt in. See [Deliverability basics](/concepts/deliverability-basics).
...
- “Emails Sent” includes all attempts; “Emails Delivered” is successful delivery. CTR is (Total Clicks / Total Sent) × 100. See [Campaign analytics](/campaigns/analytics) and [Dashboard overview](/dashboard/overview).

## What we do to protect deliverability

- We send via **Postmark** and sync with their suppression list so we don’t resend to bounced or complained addresses.
...
For more, see [Deliverability basics](/concepts/deliverability-basics) and [Contact lifecycle](/contacts/lifecycle).
