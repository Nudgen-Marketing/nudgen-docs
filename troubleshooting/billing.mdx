...
- You cannot add or upload more contacts until you’re under the limit. Either **upgrade** your plan (see [Billing overview](/billing/overview)) or **remove** contacts you no longer need. Unsubscribed and suppressed contacts still count; delete them to free space if appropriate.
...
For more, see [Billing overview](/billing/overview).
