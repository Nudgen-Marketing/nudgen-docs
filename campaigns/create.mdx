...
## Step 3: Choose brand and goal

1. Select the **brand config** (tone) for this campaign.
2. Enter the **campaign goal** — a short description of what you want to achieve. Examples:
...
The AI uses this goal and your brand tone to generate subject lines and email bodies.
...
- Emails are sent via Postmark with open and click tracking.
