...
| Metric            | Meaning                                                      |
| ----------------- | ------------------------------------------------------------ |
| **Emails Sent**   | Total emails submitted to the delivery provider.             |
| **Emails Delivered** | Successfully delivered to recipient mailboxes.           |
| **Total Opens**   | How many times the email was opened (tracking pixel).         |
| **Total Clicks**  | How many times links were clicked.                           |
| **CTR**           | Click-through rate: (clicks / delivered) × 100.              |
| **Spam Complaints** | Recipients marked the email as spam.                      |
