...
- **Watch your metrics** — High bounce or complaint rates hurt reputation. Use the [Dashboard](/en/dashboard/overview) and [Campaign analytics](/en/campaigns/analytics) to spot problems.
...
For more on contact status and suppression, see [Contact lifecycle](/en/contacts/lifecycle) and [Contacts overview](/en/contacts/overview). For sending issues, see [Troubleshooting: deliverability](/en/troubleshooting/deliverability).
