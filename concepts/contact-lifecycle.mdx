...
For step-by-step lifecycle details, see [Contact lifecycle (Contacts)](/contacts/lifecycle). For encryption and masking, see [Contacts overview](/contacts/overview).
